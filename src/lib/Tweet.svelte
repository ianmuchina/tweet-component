    ...
    <article class="tweet" lang={tweet.lang}>
      ...
      <section class="userInfo">
        ...
        <div>
          ...
          <a
            class="userName"
            href="https://twitter.com/i/user/{tweet.user.id_str}"
      ...
      <section class="meta">
        <!-- Likes -->
        <a class="likes" href="https://twitter.com/i/web/status/{tweet.id_str}">
          <svg
            xmlns:xlink="http://www.w3.org/1999/xlink"
            xmlns="http://www.w3.org/2000/svg"
            aria-hidden="true"
          ...
          {tweet.favorite_count.toLocaleString("en", {
            notation: "compact",
          })}
        </a>
...
<style lang="scss">
  ...
  :root {
    ...
    --border: var(--gray-5);
    --checkmark: var(--blue-6);

    --border-radius: 8px;
    --likes-text: inherit;
    --likes-bg: transparent;
    --likes-text-hover: var(--red-7);
    --likes-bg-hover: #ff505020;

    --link-text: inherit;
    --link-bg: transparent;
    --link-text-hover: var(--blue-7);
    --link-bg-hover: #50a2ff20;
  }
  ...
  /* 4 Images  */
  .gallery-4 img {
    /* FIXME: Backport to older browsers */
    aspect-ratio: 16 /9;
  }
</style>
